      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-slate-600 text-lg leading-relaxed mb-10">
            We let our work speak for itself. Real testimonials from Lake Logic clients coming soon.
          </p>
          <div className="inline-flex items-center gap-2 bg-white border border-slate-200 rounded-full px-6 py-3 text-sm font-medium text-navy-700 hover:bg-slate-100 transition-colors duration-200">
